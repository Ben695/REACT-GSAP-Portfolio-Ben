...
const RightProjects: React.FC<RightProjectsProps> = ({ imageUrl, title, description, buttonText, buttonUrl }) => {
  return (
    <div data-cursor-color="white" className="container-projects-right">
      ...
      <div className="contentWrapper" data-cursor-color="white">
        ...
        <a href={buttonUrl} className="styled-button" target='_blank' data-cursor-color="white" role="button">{buttonText}</a>
      </div>
      <div data-cursor-color="white" className="imageWrapper-right">
        <img data-cursor-color="black" src={imageUrl} alt="Project Image"/>
      </div>
    </div>
  );
};
